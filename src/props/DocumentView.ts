...
export interface DocumentProps extends PDFDashBaseProps {
  /** Internal page views rendered inside the document context. */
  ...
  /** Loaded document information. Read-only. */
  ...
  /** Latest internal-link navigation event. Navigation is handled automatically; use this read-only value to observe it. */
