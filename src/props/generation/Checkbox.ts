...
export interface CheckboxProps extends NodeIdentity {
  /** Renderer backgroundColor property.  */
  backgroundColor?: string;
  /** Renderer borderColor property.  */
  borderColor?: string;
  /** Renderer checked property.  */
  checked?: boolean;
  /** Renderer onState property.  */
  onState?: string;
  /** Renderer offState property.  */
  offState?: string;
  /** Renderer xMark property.  */
  xMark?: boolean;
